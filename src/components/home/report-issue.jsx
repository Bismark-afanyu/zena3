...
return (
    <div className="w-full bg-white">
        <div className="report-issue-section pt-20 p-32 rounded-lg flex flex-col lg:flex-row gap-10">
            {/* Left Side - Title and Description */}
            <div className="lg:w-1/3 flex flex-col justify-center">
                <h3 className="text-3xl font-bold text-Teal_blue-50">Report an Issue</h3>
            ...
            {/* /* Right Side - Form */} 
                        <div className="lg:w-2/3 bg-gray-35 p-8 rounded-lg shadow-md">
                            <form className="space-y-6">
                                {/* Select Issue Type */}
                                <div>
                                    <p className="block text-Teal_blue-50 text-2xl font-semibold mb-4">
                                        Select Issue Type
                                    </p>
                                    <div className="flex flex-wrap gap-4">
                                        {issueTypes.map((type, index) => (
                                            <label
                                                key={index}
                                                className={`cursor-pointer border px-4 py-3  rounded-md text-sm font-medium w-1/5 text-center ${
                                                    selectedIssue === type
