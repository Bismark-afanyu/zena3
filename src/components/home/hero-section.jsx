  ...
  const slides = [
    <div className="flex flex-col-reverse lg:flex-row items-center">
      <div className="flex flex-col gap-[60px]">
        <div className="px-[40px] flex flex-col gap-[35px]">
          <p className=" text-[26px] lg:text-[32px] font-bold text-[#264653] max-lg:text-center">
            100% Verified Providers - <br className="max-lg:hidden" />
            Book with Confidence!
          </p>
          <div className="flex items-center gap-[12px]">
            <div className="flex items-center gap-[12px]">
              <CiLocationOn size={20} className="text-yellow-50" />
              <p className="text-primary font-bold">Lekki 1</p>
            </div>
            <FaChevronDown size={20} className="text-yellow-50" />
          </div>
        </div>
    ...
    <div className="flex flex-col-reverse lg:flex-row items-center">
      <div className="flex flex-col gap-[60px]">
        <div className="px-[40px] flex flex-col gap-[35px]">
          <p className=" text-[26px] lg:text-[32px] font-bold text-[#264653] max-lg:text-center">
            Top-Rated Service Experts - <br className="max-lg:hidden" />
            in Lagos Island.
          </p>
          <div className="flex items-center gap-[12px]">
            <div className="flex items-center gap-[12px]">
    ...
    <div className="flex flex-col-reverse lg:flex-row items-center">
      <div className="flex flex-col gap-[60px]">
        <div className="px-[40px] flex flex-col gap-[35px]">
          <p className=" text-[26px] lg:text-[32px] font-bold text-[#264653] max-lg:text-center">
            Secure Payments. Hassle- <br className="max-lg:hidden" />
            Free Bookings.
          </p>
          <div className="flex items-center gap-[12px]">
            <div className="flex items-center gap-[12px]">
    ...
    <div className="min-h-screen lg:h-screen bg-white flex items-center justify-center text-black overflow-x-hidden">
      <div className="flex items-center justify-center relative w-full min-h-screen lg:h-full max-lg:py-[60px]">
        <Image
          ...
          width={24}
          height={12}
          style={{ width: "auto", height: "auto", transform: "rotate(180deg)" }}
          alt="arrow right"
